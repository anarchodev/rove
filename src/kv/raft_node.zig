...
fn handleSnapOffer(self: *RaftNode, from_id: u32, body: []const u8) void {
    ...
    const frame = snapshot.buildSnapReq(self, my_max) catch return;
    defer self.allocator.free(frame);
...
fn handleSnapReq(self: *RaftNode, from_id: u32, body: []const u8) void {
    ...
    const maybe_frame = snapshot.buildSnapData(self, kv_store, snap_term, snap_idx, after_seq, through) catch return;
...
fn handleSnapData(self: *RaftNode, body: []const u8) void {
    ...
    snapshot.applySnapData(self, kv_store, body) catch |err| {

...
//
// Lifted to an ES-module package (P-Lift, rove#123): `globalThis.cron` →
// `export default`. As an ambient global this was IIFE-wrapped, because the
// arenajs base-snapshot freeze corrupts on bare top-level function
// declarations / `Object.assign` left in the script's global lexical scope.

...
`stream(...)` + `after.kv` watched-prefix wakes). See §2.12 +
...
| 10.12 | Replay — two paths (browser page + DAP CLI), one per audience | replay-wasm-plan.md (in the rewind-apps repo, `replay/replay-wasm-plan.md`); decisions.md §8 |

...
> - [package-isolation.md](architecture/package-isolation.md) — capabilities instead of ambient authority for package code: the package-poisoning threat model, module-scope denial, intrinsic freezing, and grant-by-passing (**design of record, NOT built**; supersedes `package-resolution.md`'s P2 gate; tracker #751).

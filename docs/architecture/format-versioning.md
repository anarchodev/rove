...
| `_keys/next_slot` | `[1B v][8B end LE][8B nonce LE]` | **versioned** (`keyspace.VALUE_VERSION`, registry `keyring_kv_value`) | `src/js/keyring_slots.zig:78` | engine-only. Slots RESERVED |

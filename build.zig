...
pub fn build(b: *std.Build) void {
    ...
    const js_runtime_files: []const struct { name: []const u8, path: []const u8 } = &.{
        ...
        .{ .name = "builtin_root_domain_mjs", .path = "src/js/builtin_modules/root_domain.mjs" },
        .{ .name = "builtin_root_kv_install_mjs", .path = "src/js/builtin_modules/root_kv_install.mjs" },
        .{ .name = "builtin_root_query_mjs", .path = "src/js/builtin_modules/root_query.mjs" },
        .{ .name = "builtin_scope_kv_mjs", .path = "src/js/builtin_modules/scope_kv.mjs" },

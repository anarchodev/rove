...
from smoke_lib_v2 import V2Cluster, REPO_ROOT, APPS_DIR, require_apps_dir  # noqa: E402
...
def main() -> int:
    ...
    with V2Cluster.spawn("rwpub", nodes=1,
        ...
        try:
            ...
            # globals on 2026-07-28. The spec list comes from the app's own
            # manifest, so a dependency the app adds is seeded without editing
            # this smoke.

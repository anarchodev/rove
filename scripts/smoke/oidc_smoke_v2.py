...
from smoke_lib_v2 import V2Cluster, PUBLIC_SUFFIX, REPO_ROOT, APPS_DIR, require_apps_dir  # noqa: E402
...
def main() -> int:
    ...
    with V2Cluster.spawn("oidc", nodes=1) as c:
        ...
        r = c.node_kv_put("__auth__", "_oidc/config/default", cfg, raw=True)

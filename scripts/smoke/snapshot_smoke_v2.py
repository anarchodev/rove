...
a SEPARATE V2 port, `scripts/smoke/snap_catchup_smoke_v2.py`, which proves the full
...
def main() -> int:
    ...
    print("scripts/smoke/snap_catchup_smoke_v2.py (which now proves the full rejoin-catchup")

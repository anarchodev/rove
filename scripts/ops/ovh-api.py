...
Usage:
    scripts/ops/ovh-api.py GET  /me
    scripts/ops/ovh-api.py GET  /vrack
    scripts/ops/ovh-api.py GET  /dedicated/server
    scripts/ops/ovh-api.py POST /vrack/pn-XXXX/dedicatedServerInterface '{"dedicatedServerInterface":"<uuid>"}'

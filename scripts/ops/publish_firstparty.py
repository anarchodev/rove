...
Usage:
  scripts/ops/publish_firstparty.py                    # every operator tenant
  scripts/ops/publish_firstparty.py marketing docs     # only these (any kind)
  scripts/ops/publish_firstparty.py --include-examples # operator + example tenants
  scripts/ops/publish_firstparty.py --dry-run          # print the rewind-ops calls only
  scripts/ops/publish_firstparty.py --no-release       # stage but don't flip live
  scripts/ops/publish_firstparty.py --ops-bin ./zig-out/bin/rewind-ops --env ./.env.prod
"""
import argparse
import json
import os

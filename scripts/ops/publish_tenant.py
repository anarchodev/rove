...
Usage:
    scripts/ops/publish_tenant.py marketing web/marketing
    scripts/ops/publish_tenant.py docs web/docs --provision --host docs.rewindjs.com
    scripts/ops/publish_tenant.py marketing web/marketing --verify-host rewindjs.com
"""
import argparse
import json
import mimetypes

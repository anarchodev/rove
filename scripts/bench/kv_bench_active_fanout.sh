...
#
# Usage:
#   N_ACTIVE=64 bash scripts/bench/kv_bench_active_fanout.sh
#   N_ACTIVE=128 N_IDLE=10000 bash scripts/bench/kv_bench_active_fanout.sh
#   MODE=zipf N_ACTIVE=128 STEADY_S=30 bash scripts/bench/kv_bench_active_fanout.sh
#   HANDLER=rwbench N_ACTIVE=128 bash scripts/bench/kv_bench_active_fanout.sh
#
# Env knobs:
